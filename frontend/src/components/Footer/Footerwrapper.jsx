        ...
        <div className={style.footer_main_part3}>
          <div>
            ...
            <div className={style.footer_main_part3_b}>
              <a href="/" className={style.footer_main_part3_b_i}>
                <svg
                  data-swarm-icon="true"
                  height="28"
                  width="28"
                  viewBox="0 0 28 28"
                  className={style.text_gray3}
                >
          ...
          <div className={style.footer_main_part3_2}>
            <a href="/" className={style.footer_main_part3_3}>
              <div className={style.footer_main_part3_4}>
                <img
                  className={style.footer_main_part3_4_img}
                  src="https://secure-content.meetupstatic.com/images/next/images/app-download/android/download_en-US.svg?w=256"
                  alt=""
                />
              </div>
            </a>
            <a href="/" className={style.footer_main_part3_3}>
              <div className={style.footer_main_part3_4}>
                <img
                  className={style.footer_main_part3_4_img}
                  src="https://secure-content.meetupstatic.com/images/next/images/app-download/ios/download_en-US.svg?w=256"
                  alt=""
                />
              </div>
            </a>
