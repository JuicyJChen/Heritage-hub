  ...
  return (
    <div>
      ...
      <div className={styles.eve1}>
        ...
        <h1>
          <input
            ...
            /* value={header} */ placeholder="Search For Topics"
      ...
      <div className={styles.eve2}>
        ...
        <div>
          <button
            value={"Crafts"} /* onClick={(e) => handleInput(e, 'value')} */
          >
            Crafts
          </button>
          <button
        ...
        <div>
          <button
            value={
              "Collabaration Between Creative Minds"
            } /* onClick={(e) => handleInput(e, 'value')} */
          >
          ...
          <button value={"Tech"} /* onClick={(e) => handleInput(e, 'value')} */>
            Tech
          </button>
        </div>
      </div>
